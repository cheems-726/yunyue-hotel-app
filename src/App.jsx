...
function HelpPage({ onBack }) {
  const sections = [
    ...
    { icon: '👥', title: '组队共管', body: '老师把几位同学设为同班级+同组号后，你们将共同经营同一家酒店：任何人登录看到的都是同一份进度，决策互相接续。「小组成员」页可查看队友的酒店概况和称号。差评处理建议分工：🛎️大堂经理主笔回复话术（回复靠诚意得分，敷衍的回复等于没回），👔店长把关补偿尺度（补偿成本计入周结算），每周结算后全组一起过一遍口碑页——差评欠 2 条以上会触发「差评发酵」危机，别攒着。' },
