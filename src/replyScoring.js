...
const NEG_RULES = [
  ...
  { re: /立即|马上|第一时间|已在|当天|加急|今晚/, pts: 2 },
  { re: /24小时|明天(上午|下午|之前)?|今日内|今天晚上|[一二三四五六七八九十]{1,2}点前|周末前/, pts: 3 },
  { re: /培训|流程|制度|优化|改进|杜绝|避免再次/, pts: 1 },
  { re: /联系|电话|微信|前台|回访|跟进|随时|反馈渠道/, pts: 2 },
  { re: /感谢|反馈|监督|意见/, pts: 1 },
  { re: /理解|感受|换位|体会|给您带来的不便|让您/, pts: 2 },
